...
import com.webclient.integrationtest.webclientintegrationtest.model.Role;
...
class EmployeeServiceUnitTest {
    ...
    void givenEmployee_whenAddEmployee_thenAddNewEmployee() {
        ...
        when(requestBodyMock.body(newEmployee, Employee.class)).thenReturn(requestHeadersMock);
        when(requestHeadersMock.retrieve()).thenReturn(responseMock);
    ...
    void givenEmployee_whenupdateEmployee_thenUpdatedEmployee() {
        ...
        when(requestBodyMock.body(updateEmployee, Employee.class)).thenReturn(requestHeadersMock);
        when(requestHeadersMock.retrieve()).thenReturn(responseMock);
